...
>
    <div
            ...
            class="bg-white rounded-2xl shadow-lg max-w-[600px] w-full p-6"
    >
        <div class="flex justify-end">
            <button @click="{{ $key }} = false" type="button" class="text-gray-500 text-xl font-bold hover:text-gray-700">
