                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex flex-col gap-[16px]">
                            <template x-for="description in dataTariff[selectedTariff - 1]['description']" :key="description">
                                <div class="h-[58px] w-full rounded-[6px] flex items-center gap-[10px] bg-[#F7F8F9] px-[20px]">
                                    <div class="rounded-full h-[6px] w-[6px] bg-black"></div>
